...
export const WeeklyTrendCard: React.FC<WeeklyTrendCardProps> = ({ transactions }) => {
  ...
  return (
    ...
    >
      ...
      <div className="p-4 sm:p-5 border-b border-stone-200/80 bg-stone-50/50 flex flex-col md:flex-row md:items-center justify-between gap-3">
        <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-stone-200/80 border-b border-stone-200/80 bg-white">
        {/* 1. Toplam Kazanç */}
        ...
        <div className="p-4 sm:p-5 flex items-center justify-between">
          <div>
            ...
            <div
              className={`text-2xl font-black tracking-tight ${
                netWeekBalance >= 0 ? 'text-stone-900' : 'text-rose-700'
              }`}
            >
          ...
          <span className="w-10 h-10 rounded-xl bg-stone-100 text-stone-700 flex items-center justify-center shrink-0">
      ...
      <div className="p-4 sm:p-5 bg-stone-50/20">
        ...
        <div className="grid grid-cols-7 gap-1.5 sm:gap-2 mt-3 pt-3 border-t border-stone-200/80 text-center">
          {weekDays.map((d) => (
            <div
              key={d.dateStr}
            ...
            >
              <div className="text-[11px] font-bold text-stone-600 flex items-center justify-center gap-1">
